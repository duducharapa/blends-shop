...
/**
 * Card used to render the information about a given item from order.
 * @param {ItemCardProps} props The component props.
 * @param {OrderItem} props.item Item to render.
 * @return {ReactElement} The card UI for order item.
 */
const ItemCard = ({ item }: ItemCardProps): ReactElement => {
  ...
  return (
    <div
      className={`
        p-4 flex gap-1 md:gap-0 flex-column md:flex-row justify-content-between
    ...
    >
      <div className='flex flex-column md:flex-row justify-content-center md:justify-content-start'>
        <Image src={product.image}
          width='100'
          className='border-round align-self-center'
        />
